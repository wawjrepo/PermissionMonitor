...
public class NormalMethodList extends HookMethodList {
    ...
    public LinkedList<ClassMethodGroup> getAbsMethodList() {
        ...
        //PackageManager
        ClassMethodGroup aPkgManagerHook = new ClassMethodGroup("android.app.ApplicationPackageManager");
        aPkgManagerHook.addMethod("getInstalledPackages");
        aPkgManagerHook.addMethod("getInstalledApplications"); //获取应用信息
        aPkgManagerHook.addMethod("queryIntentActivities");
        aPkgManagerHook.addMethod("getInstallerPackageName");
        aPkgManagerHook.addMethod("getPackageInfoAsUser");
        list.add(aPkgManagerHook);

        ClassMethodGroup pkgManagerHook = new ClassMethodGroup("android.app.PackageManager");
        pkgManagerHook.addMethod("getInstalledPackages");
        pkgManagerHook.addMethod("getInstalledApplications");
        list.add(pkgManagerHook);

        ClassMethodGroup acManagerHook = new ClassMethodGroup("android.app.ActivityManager");
        acManagerHook.addMethod("getRunningAppProcesses");
        list.add(acManagerHook);
...
//        list.add(new MethodWrapper(Host.class,"fuck",int.class));
        ...
        list.add(new MethodWrapper(android.net.wifi.WifiInfo.class, "getBSSID"));
